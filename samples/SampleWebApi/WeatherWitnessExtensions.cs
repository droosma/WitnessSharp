...
{
    public static void LogForecastRequested(this IWitness<Program> witness, string city)
    {
        witness.Logger.LogInformation("Weather forecast requested for {City}", city);
    }

    public static void LogForecastFailed(this IWitness<Program> witness, string city, Exception ex)
    {
